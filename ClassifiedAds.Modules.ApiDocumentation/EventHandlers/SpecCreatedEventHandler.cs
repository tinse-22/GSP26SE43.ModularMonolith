...
public class SpecCreatedEventHandler : IDomainEventHandler<EntityCreatedEvent<ApiSpecification>>
{
    ...
    public SpecCreatedEventHandler(ICurrentUser currentUser,
    ...
    public async Task HandleAsync(EntityCreatedEvent<ApiSpecification> domainEvent, CancellationToken cancellationToken = default)
    {
        var auditLog = new AuditLogEntry
        {
            UserId = _currentUser.IsAuthenticated ? _currentUser.UserId : Guid.Empty,
            CreatedDateTime = domainEvent.EventDateTime,
            Action = "UPLOADED_SPEC",
        ...
        await _outboxMessageRepository.AddOrUpdateAsync(new OutboxMessage
        {
            EventType = EventTypeConstants.SpecUploaded,
            TriggeredById = _currentUser.IsAuthenticated ? _currentUser.UserId : Guid.Empty,
            CreatedDateTime = domainEvent.EventDateTime,
            ObjectId = domainEvent.Entity.Id.ToString(),
